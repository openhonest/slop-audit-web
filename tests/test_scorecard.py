...
# The grade rule (hygiene weighting, A/B/C thresholds) now lives in the engine and is
# unit-tested there (l1_analyzer test_grade_summary). The web consumes grade_summary via
# build_scorecard; test_grade_gates_the_tier_on_the_verdict above covers that integration.
